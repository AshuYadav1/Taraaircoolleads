...
export default function ACServiceGallery() {
  ...
  const serviceImages = {
    repair: [
      {
        src: "/Ac Emergency Gas filling.jpg",
      ...
      {
        src: "/Compressor Replacement.jpg", 
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
            <div className="flex items-center mb-4">
              <img
                src="https://ui-avatars.com/api/?name=D&background=0D8ABC&color=fff&size=60"
                alt="Satisfied customer from Dahisar"
                className="w-12 h-12 rounded-full mr-3"
                loading="lazy"
              />
              <div>
                <div className="font-semibold text-gray-900">Dhruv Jain</div>
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
            <div className="flex items-center mb-4">
              <img
                src="https://ui-avatars.com/api/?name=B&background=28A745&color=fff&size=60"
                alt="Happy customer from Borivali"
                className="w-12 h-12 rounded-full mr-3"
                loading="lazy"
              />
              <div>
                <div className="font-semibold text-gray-900">Bhavesh Solanki</div>
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
            <div className="flex items-center mb-4">
              <img
                src="https://ui-avatars.com/api/?name=M&background=FFC107&color=fff&size=60"
                alt="Customer testimonial from Mira Road"
                className="w-12 h-12 rounded-full mr-3"
                loading="lazy"
              />
              <div>
                <div className="font-semibold text-gray-900">Mansi Singh</div>
